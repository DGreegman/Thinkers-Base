        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <motion.p
              ...
              className="font-poppins text-white/80 text-lg leading-relaxed mb-8 max-w-lg"
            >
          ...
          >
            {[
              ...
              >
                ...
                <div className="font-poppins text-white/70 text-xs leading-snug">
                  {item.label}
                </div>
              </motion.div>
            ))}
  ...
  return (
    <section ref={ref} className="py-20 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="font-poppins text-charcoal/80 text-lg leading-relaxed mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {strategies.map((strategy, i) => (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-card p-5 flex items-start gap-3"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.1, duration: 0.5 }} className="bg-white rounded-card p-6 shadow-card">
            ...
            <p className="font-poppins text-charcoal/75 text-sm">Starts in September and ends in July. Divided into three terms with short holidays in between.</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.2, duration: 0.5 }} className="bg-white rounded-card p-6 shadow-card">
            ...
            <p className="font-poppins text-charcoal/75 text-sm">8:00am to 2:00pm. Children are expected to be in school before 8:00am.</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.3, duration: 0.5 }} className="bg-white rounded-card p-6 shadow-card">
            ...
            <p className="font-poppins text-charcoal/75 text-sm">Monday to Friday, except on public holidays.</p>
          </motion.div>
        </div>
      </div>
    </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.1, duration: 0.5 }} className="bg-white rounded-card p-8 shadow-card">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2 text-sm text-charcoal/75">
...
// ─────────────────────────────────────────────────────────────────────────────
// 1K. PRINCIPAL'S MESSAGE / GRATITUDE — with Head Teacher photo
// ─────────────────────────────────────────────────────────────────────────────
          ...
          <div className="bg-forest rounded-[24px] p-8 md:p-12">
            <div className="grid md:grid-cols-3 gap-8 items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="font-poppins text-leaf text-sm text-center">School Head</p>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-6 pt-6 border-t border-white/20">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-poppins text-white/60 text-xs ml-2">School Head, Thinkers Base Academy</span>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="pl-8">
              ...
              <p className="font-nunito font-extrabold text-2xl sm:text-3xl text-forest leading-snug mb-6">
                We started with a handful of children, a rented classroom, and a stubborn belief that every child deserves a school that truly sees them.
              </p>
              <p className="font-poppins text-charcoal/60 text-sm">— Mrs. Grace Eze, Founding Principal</p>
            </div>
            <div className="absolute -bottom-4 -right-4 font-nunito font-extrabold text-[120px] text-forest/5 leading-none select-none pointer-events-none">2009</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="space-y-5 font-poppins text-charcoal/80 text-base leading-relaxed"
          >
            <p>Thinkers Base Academy opened its doors in <strong className="text-forest">2009</strong> as a small nursery school on the edge of the city, founded by a group of parents and educators who believed that the earliest years of a child&apos;s life deserved more intention, more warmth, and more joy than they were finding elsewhere.</p>
            <p>By 2013, the demand from families who had seen what we did for their nursery children led us to open our <strong className="text-forest">Primary School</strong>. We grew carefully, class by class, never adding a year group until we were certain the teachers, spaces and culture were exactly right.</p>
            <p>In 2019, our first cohort of primary graduates were ready for secondary school, and their parents asked us the obvious question: <em className="text-forest">&quot;Why can&apos;t you just keep going?&quot;</em> So we did.</p>
            <p>Today, Thinkers Base Academy is home to nearly <strong className="text-forest">950 pupils</strong> across three stages — but the same founding values guide every classroom, every corridor, and every conversation.</p>
    ...
    <section ref={ref} className="py-20 bg-forest relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="text-center mb-16">
          ...
          <p className="font-poppins text-white/80 text-base max-w-lg mx-auto">From a single nursery classroom to a full Nursery–Secondary campus. Each milestone is a story of families who trusted us with their most precious people.</p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.2 }} className="flex flex-wrap justify-center gap-3 mb-12">
          {(Object.entries(stageLabels) as [MilestoneStage, string][]).map(([stage, label]) => {
            const colors: Record<MilestoneStage, string> = { nursery: "#F4D03F", primary: "#5BA4CF", secondary: "#E8845C" };
            return (
              <span key={stage} className="font-nunito font-bold text-xs px-3 py-1.5 rounded-button" style={{ backgroundColor: colors[stage] + "33", color: colors[stage] }}>
                {label}
              </span>
            );
          })}
        ...
        <div className="relative">
          ...
          <div className="space-y-10">
            {milestones.map((m, i) => {
              ...
              return (
                <motion.div key={m.year} initial={{ opacity: 0, x: isLeft ? -32 : 32 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ delay: i * 0.08, duration: 0.5 }} className={`relative flex items-start gap-4 sm:gap-0 ${isLeft ? "sm:flex-row" : "sm:flex-row-reverse"}`}>
                  <button
                  ...
                  <div className="absolute left-4 sm:left-1/2 sm:-translate-x-1/2 top-4 w-8 h-8 rounded-full border-4 border-forest flex items-center justify-center text-sm z-10 shadow-md transition-transform hover:scale-110" style={{ backgroundColor: m.color }}>
                    {m.emoji}
                  </div>
                </motion.div>
              );
...
function MissionVisionValues() {
  ...
  const cards = [
    { icon: Target, title: "Our Mission", color: "#52B788", bg: "#F0FFF4", content: "To provide an exceptional, inclusive education that nurtures every child's unique potential — from their very first day in nursery to the moment they step into the world as confident, capable young people.", type: "paragraph" as const },
...
function TeamGrid() {
  ...
  const stageColors: Record<string, string> = { nursery: "#F4D03F", primary: "#5BA4CF", secondary: "#E8845C", all: "#52B788" };
...
function useCounter(target: number, started: boolean) {
  ...
  if (started && count === 0 && target > 0) {
    ...
    ref.current = setInterval(() => {
      setCount((c) => { if (c + step >= target) { clearInterval(ref.current!); return target; } return c + step; });
    }, 24);
  }
  return count;
}
...
function StatChip({ emoji, value, suffix, label, index, started }: { emoji: string; value: string; suffix: string; label: string; index: number; started: boolean }) {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.08 }} className="flex flex-col items-center gap-1 px-4">
      ...
      <span className="font-nunito font-extrabold text-3xl sm:text-4xl text-white tabular-nums">{num}{suffix}</span>
    ...
    <section ref={ref} className="py-20 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }} className="text-center mb-12">
          ...
          <p className="font-poppins text-charcoal/60 text-base max-w-md mx-auto">Replace these placeholders with real photos once you have them. Each one tells a story.</p>
        </motion.div>

        <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
          {photos.map((photo, i) => (
            <motion.div key={photo.label} initial={{ opacity: 0, scale: 0.93 }} animate={inView ? { opacity: 1, scale: 1 } : {}} transition={{ delay: i * 0.06, duration: 0.4 }} whileHover={{ scale: 1.04, transition: { duration: 0.2 } }} className={`${photo.size} aspect-square rounded-2xl flex flex-col items-center justify-center shadow-card hover:shadow-card-hover cursor-pointer border-2 border-white transition-shadow`} style={{ backgroundColor: photo.bg }}>
              <span className="text-4xl sm:text-5xl mb-2">{photo.emoji}</span>
              <span className="font-nunito font-bold text-forest/60 text-[10px] sm:text-xs text-center px-2">{photo.label}</span>
            </motion.div>
          ))}
        </div>
      </div>
