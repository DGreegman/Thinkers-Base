    ...
    <section ref={ref} className="py-20 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <p>
              Greenleaf Academy opened its doors in <strong className="text-forest">2009</strong> as
            ...
            <p>
              Today, Greenleaf Academy is home to nearly <strong className="text-forest">950 pupils</strong> across
...
const milestones = [
  { year: "2009", title: "Nursery Opens",              emoji: "🌱", stage: "nursery",   desc: "Greenleaf Nursery opens with 24 children and 4 staff in a rented community hall.",                   color: "#F4D03F" },
  ...
  { year: "2018", title: "Outstanding EYFS Rating",    emoji: "🏆", stage: "primary",   desc: "Greenleaf receives an Outstanding rating for our Early Years provision — top 8% nationally.",         color: "#5BA4CF" },
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className={`flex-1 ml-14 sm:ml-0 text-left bg-white/10 backdrop-blur-sm border rounded-card p-5 transition-all duration-300 cursor-pointer ${
...
const team = [
  { name: "Mrs. Grace Eze",      role: "Founding Principal",         stage: "all",       initials: "GE", bio: "Grace founded Greenleaf in 2009 after 15 years in education. She believes every child has a gift — her job is to help them find it.",      color: "#52B788" },
  ...
  { name: "Mrs. Amaka Chukwu",   role: "Head of Primary",            stage: "primary",   initials: "AC", bio: "Amaka has been with Greenleaf since 2013. Her classrooms are always the loudest — in the best possible way.",                              color: "#5BA4CF" },
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="font-poppins text-white/65 text-sm mb-7 max-w-md mx-auto leading-relaxed">
              No website can fully show you what Greenleaf feels like. Book a
