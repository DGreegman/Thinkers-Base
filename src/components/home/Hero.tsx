...
// ── Tiny leaf SVG background pattern ─────────────────────────────────────────
...
function AnimatedHeadline({ text }: { text: string }) {
  ...
  return (
    <h1 className="font-nunito font-extrabold text-4xl sm:text-5xl lg:text-6xl text-forest leading-[1.1] mb-5">
      {words.map((word, i) => (
        <motion.span
          key={i}
  ...
  return (
    <section className="relative bg-cream overflow-hidden min-h-[88vh] flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative z-10">
            ...
            {/* Headline */}
            <AnimatedHeadline text="Every Child Belongs Here." />
            ...
            >
              A nurturing school where little ones play their way into learning,
              curious minds discover their passions, and ambitious students shape
              their futures.
            </motion.p>
      ...
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden leading-none pointer-events-none">
        <svg viewBox="0 0 1440 40" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full h-10 block">
